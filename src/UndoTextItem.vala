...
public class UndoTextItem : UndoItem {
  ...
  */
  public virtual bool merge( CanvasItemText ct, UndoTextItem item ) {
    return( false );
  }

  /* Performs an undo of the text item */
  public virtual void undo_text( Canvas canvas, CanvasItemText ct ) {}

  /* Performs a redo of the text item */
  public virtual void redo_text( Canvas canvas, CanvasItemText ct ) {}
