...
public class UndoBuffer : Object {
  ...
  //-------------------------------------------------------------
  // Default constructor
  public UndoBuffer( Canvas canvas ) {
    _canvas      = canvas;
  ...
  //-------------------------------------------------------------
  // Attempts to replace the last item in the undo buffer with
  // the given item if both items are the same type; otherwise,
  // the new item will just be added like any other item.
  ...
  //-------------------------------------------------------------
  // Outputs the state of the undo and redo buffers to standard
  // output
